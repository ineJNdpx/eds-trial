...
## Environments
- Preview: https://main--eds-trial--ineJNdpx.aem.page/
- Live: https://main--eds-trial--ineJNdpx.aem.live/
...
1. Open the `eds-trial` directory in your favorite IDE and start coding :)
